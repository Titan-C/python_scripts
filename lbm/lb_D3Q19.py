...
#LBM steps
    ...
    def force(self,F):
        ...
        F3 = 1./18. *(   -ux *F[0] - (1-uy)*F[1]  -    uz *F[2] + 3*uy*F[1])
        F4 = 1./18. *(   -ux *F[0] -(-1-uy)*F[1]  -    uz *F[2] + 3*uy*F[1])
        F5 = 1./18. *(   -ux *F[0] -    uy *F[1]  - (1-uz)*F[2] + 3*uz*F[2])
        F6 = 1./18. *(   -ux *F[0] -    uy *F[1]  -(-1-uz)*F[2] + 3*uz*F[2])
